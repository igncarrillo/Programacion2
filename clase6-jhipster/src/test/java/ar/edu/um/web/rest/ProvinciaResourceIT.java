...
import ar.edu.um.repository.ProvinciaRepository;
...
class ProvinciaResourceIT {
    ...
    public static Provincia createEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombre(DEFAULT_NOMBRE).zipcode(DEFAULT_ZIPCODE);
        return provincia;
    }
    ...
    public static Provincia createUpdatedEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombre(UPDATED_NOMBRE).zipcode(UPDATED_ZIPCODE);
        return provincia;
    }
    ...
    void createProvincia() throws Exception {
        ...
        assertThat(testProvincia.getZipcode()).isEqualTo(DEFAULT_ZIPCODE);
    }
    ...
    void putNewProvincia() throws Exception {
        ...
        updatedProvincia.nombre(UPDATED_NOMBRE).zipcode(UPDATED_ZIPCODE);
        ...
        assertThat(testProvincia.getZipcode()).isEqualTo(UPDATED_ZIPCODE);
    }
    ...
    void fullUpdateProvinciaWithPatch() throws Exception {
        ...
        partialUpdatedProvincia.nombre(UPDATED_NOMBRE).zipcode(UPDATED_ZIPCODE);
