...
/**
 * REST controller for managing {@link ar.edu.um.domain.Provincia}.
 */
@RestController
@RequestMapping("/api")
public class ProvinciaResource {
    ...
    public ResponseEntity<Provincia> updateProvincia(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, provincia.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Provincia> partialUpdateProvincia(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, provincia.getId().toString())
        );
    }
